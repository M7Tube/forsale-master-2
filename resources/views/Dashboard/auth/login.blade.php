                        ...
                        <div class="col-lg-10">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Login <i
                                            class="bi bi-box-arrow-in-right"></i></h3>
                                ...
                                <div class="card-body">
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="inputEmail">Email address <i class="bi bi-envelope"></i></label>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="inputPassword">Password <i class="bi bi-key"></i></label>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button type="submit"
                                                class="mx-auto w-50 btn btn-block btn-outline-primary">Login <i
