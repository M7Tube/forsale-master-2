...
@section('tableName', __('Years Of Experience'))
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-outline-primary mb-2" data-bs-toggle="modal"
                        data-bs-target="#editModal" wire:click.prevent="edit({{ $data->YOE_id }})"><i
...
@section('create-model-body')
    @if (Session()->has('WrongYearsOfExperience'))
        <div class="alert alert-danger">
            {{ Session('WrongYearsOfExperience') }}
        </div>
    @endif
    @if (!Session()->has('WrongYearsOfExperience'))
        <div class="card-body">
